...
---
## [2026-09-12] Задача: k8s — закрытие (перенос не нужен)
- Цель: зафиксировать отмену этапа 2 по решению пользователя.
- Сделано: tasks/current.md обновлён — этап 2 «перенос стенда в поды» отменён (k8s — для новых экспериментов), этап 3 уведён в опциональный backlog; задача закрыта, этапы 0–1 выполнены.
- Остановились на: задача завершена; кластер k3s + GPU в работе, площадка готова.
- Ключевые решения: ничего из docker-compose в поды не переносим; stand/ остаётся референсом.
- Следующий шаг: новые задачи пользователя (через grill-me) — запуск подов/экспериментов.
- Артефакты: tasks/current.md, k8s/, stand/ (референс)
---
